...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'core.handler.feed' => 'getCore_Handler_FeedService',
            'core.handler.rss' => 'getCore_Handler_RssService',
            'core.handler.user' => 'getCore_Handler_UserService',
            'core.handler.user_rss' => 'getCore_Handler_UserRssService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('hPBvX8dfQd', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x0qB3eKmMP', 0, '99FEQMUUXKCa73oYrD0+lw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+Um915er1e', 0, '99FEQMUUXKCa73oYrD0+lw', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iEPcUflkhh', 0, '99FEQMUUXKCa73oYrD0+lw', (__DIR__.'/pools'), $a));
    ...
    /**
     * Gets the 'core.handler.feed' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CoreBundle\Handler\FeedHandler A CoreBundle\Handler\FeedHandler instance
     */
    protected function getCore_Handler_FeedService()
    {
        return $this->services['core.handler.feed'] = new \CoreBundle\Handler\FeedHandler($this->get('doctrine'), $this->get('feedio'), $this->get('core.handler.rss'));
    }

    /**
     * Gets the 'core.handler.rss' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CoreBundle\Handler\RssHandler A CoreBundle\Handler\RssHandler instance
     */
    protected function getCore_Handler_RssService()
    {
        return $this->services['core.handler.rss'] = new \CoreBundle\Handler\RssHandler($this->get('doctrine'));
    }

    /**
     * Gets the 'core.handler.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CoreBundle\Handler\UserHandler A CoreBundle\Handler\UserHandler instance
     */
    protected function getCore_Handler_UserService()
    {
        return $this->services['core.handler.user'] = new \CoreBundle\Handler\UserHandler($this->get('doctrine'));
    }

    /**
     * Gets the 'core.handler.user_rss' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CoreBundle\Handler\UserRssHandler A CoreBundle\Handler\UserRssHandler instance
     */
    protected function getCore_Handler_UserRssService()
    {
        return $this->services['core.handler.user_rss'] = new \CoreBundle\Handler\UserRssHandler($this->get('doctrine'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'parser', 'user' => 'igor', 'password' => 294200, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2e953d8dcb5d0344e0c2637cd37e07bbdd415fbadc6804b2364048014bc41108');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e201ed815273cdd61ba5f4788db9c050192ca7dd');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5804cbaddf5b47.77481293')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'igor',
            'database_password' => 294200,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'e201ed815273cdd61ba5f4788db9c050192ca7dd',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'e201ed815273cdd61ba5f4788db9c050192ca7dd',
            ...
            'feedio.client.class' => 'FeedIo\\Adapter\\Guzzle\\Client',
            'feedio.class' => 'FeedIo\\FeedIo',
